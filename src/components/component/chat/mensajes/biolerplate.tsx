...
export function Boilerplate_mensaje({ mensaje, params }: Props) {
  ...
  return (
    <div className={`flex items-start gap-2.5 ${isCurrentUser ? 'justify-end' : ''}`}>
      ...
      <div className={`flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 ${isCurrentUser ? 'rounded-s-xl rounded-se-xl' : 'rounded-e-xl rounded-es-xl'} dark:bg-gray-700`}>
